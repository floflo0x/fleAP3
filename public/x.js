                ...
                <div class="row mb-1" id="get_movies_detail">
                  <div class="col-12 col-sm-12">
                    ...
                    <div class="mb-3">
                      ...
                      <input type="text" class="form-control" id="exampleFormControlName_${movieParts.id}" name="title" placeholder="e.g., abcd">
                    </div>
                      <!-- description -->
                    <div class="mb-3">
                      <label for="exampleFormControlTextarea1_${movieParts.id}" class="form-label">Description</label>
                      <textarea class="form-control" name="description" id="exampleFormControlTextarea1_${movieParts.id}" rows="3"></textarea>
                    </div>
                      <!-- cast -->
                    <div class="mb-3">
                      <label for="exampleFormControlTextarea2_${movieParts.id}" class="form-label">Cast</label>
                      <textarea class="form-control" name="cast" id="exampleFormControlTextarea2_${movieParts.id}" rows="3"></textarea>
                    </div>
                      <!-- creator -->
                    <div class="mb-3">
                      <label for="exampleFormControlCreator_${movieParts.id}" class="form-label">Creator</label>
                      <input type="text" class="form-control" name="creator" id="exampleFormControlCreator_${movieParts.id}" placeholder="e.g., xyz">
                    </div>
                      <!-- age -->
                    <div class="mb-3">
                      <label for="exampleFormControlAge_${movieParts.id}" class="form-label">Age</label>
                        <input type="number" class="form-control" name="age"  id="exampleFormControlAge_${movieParts.id}" placeholder="e.g., 12" min="12" max="50">
                    </div>
                      <!-- release date -->
                    <div class="mb-3">
                      <label for="exampleFormControlDate_${movieParts.id}" class="form-label">Release Date</label>
                        <input type="date" class="form-control" id="exampleFormControlDate_${movieParts.id}" name="release_date">
                    </div>
                      <!-- type -->
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                      ...
                      <div>
                          ...
                          <input class="form-control" type="file" id="formFilel_${movieParts.id}">
                    ...
                    <div class="mb-3">
                      ...
                      <div>
                        ...
                        <input class="form-control" type="file" id="formFilep_${movieParts.id}">
                    ...
                    <div class="mb-3">
                      ...
                      <div>
                          ...
                          <input class="form-control" type="file" id="formFilebg_${movieParts.id}">
              ...
              <div class="row mb-1" id="get_movies_detail">
                <div class="col-12 col-sm-12">
                  ...
                  <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="exampleFormControlName" name="title" placeholder="e.g., abcd">
                  </div>
                    <!-- description -->
                  <div class="mb-3">
                  ...
                  <div class="mb-3">
                    ...
                    <textarea class="form-control" name="cast" id="exampleFormControlTextarea2" rows="3"></textarea>
                  </div>
                    <!-- creator -->
                  <div class="mb-3">
                    <label for="exampleFormControlCreator" class="form-label">Creator</label>
                    <input type="text" class="form-control" name="creator" id="exampleFormControlCreator" placeholder="e.g., xyz">
                  </div>
                    <!-- age -->
                  <div class="mb-3">
                    <label for="exampleFormControlAge" class="form-label">Age</label>
                      <input type="number" class="form-control" name="age"  id="exampleFormControlAge" placeholder="e.g., 12" min="12" max="50">
                  </div>
                    <!-- release date -->
                  <div class="mb-3">
                    <label for="exampleFormControlDate" class="form-label">Release Date</label>
                      <input type="date" class="form-control" id="exampleFormControlDate" name="release_date">
                  </div>
                    <!-- type -->
                  <div class="mb-3">
                    <label class="form-label">Type</label>
                  ...
                  <div class="mb-3">
                    ...
                    <div>
                        ...
                        <input type="hidden" name="logo" id="formNameFile1">
                      </div>
                      <div class="d-flex align-items-center justify-content-between">
                        <button type="button" class="btn border-0" id="upload-image-btn1">
                          <i class="fa-solid fa-cloud-arrow-up"></i>
                        </button>
                        <div id="spinner_sub_1" class="spinner-border" role="status" style="display: none;">
                          <span class="sr-only">Loading...</span>
                        </div>
                      </div>
                  </div>
                  ...
                  <div class="mb-3">
                    ...
                    <div>
                      ...
                      <input type="hidden" name="poster_img" id="formNameFile2">
                    </div>
                    <div class="d-flex align-items-center justify-content-between">
                      <button type="button" class="btn border-0" id="upload-image-btn2">
                        <i class="fa-solid fa-cloud-arrow-up"></i>
                      </button>
                      <div id="spinner_sub_2" class="spinner-border" role="status" style="display: none;">
                        <span class="sr-only">Loading...</span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="mb-3">
                    ...
                    <div>
                      ...
                      <input type="hidden" name="bg_img" id="formNameFile3">
                    </div>
                    <div class="d-flex align-items-center justify-content-between">
                      <button type="button" class="btn border-0" id="upload-image-btn3">
                        <i class="fa-solid fa-cloud-arrow-up"></i>
                      </button>
                      <div id="spinner_sub_3" class="spinner-border" role="status" style="display: none;">
                        <span class="sr-only">Loading...</span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row mb-1" id="get_movies_detail">
                    <div class="col-12 col-sm-12">
                      ...
                      <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="exampleFormControlName_${tvShow.id}" name="title" placeholder="e.g., abcd">
                      </div>
                        <!-- description -->
                      <div class="mb-3">
                        <label for="exampleFormControlTextarea1_${tvShow.id}" class="form-label">Description</label>
                        <textarea class="form-control" name="description" id="exampleFormControlTextarea1_${tvShow.id}" rows="3"></textarea>
                      </div>
                        <!-- cast -->
                      <div class="mb-3">
                        <label for="exampleFormControlTextarea2_${tvShow.id}" class="form-label">Cast</label>
                        <textarea class="form-control" name="cast" id="exampleFormControlTextarea2_${tvShow.id}" rows="3"></textarea>
                      </div>
                        <!-- creator -->
                      <div class="mb-3">
                        <label for="exampleFormControlCreator_${tvShow.id}" class="form-label">Creator</label>
                        <input type="text" class="form-control" name="creator" id="exampleFormControlCreator_${tvShow.id}" placeholder="e.g., xyz">
                      </div>
                        <!-- age -->
                      <div class="mb-3">
                        <label for="exampleFormControlAge_${tvShow.id}" class="form-label">Age</label>
                          <input type="number" class="form-control" name="age"  id="exampleFormControlAge_${tvShow.id}" placeholder="e.g., 12" min="12" max="50">
                      </div>
                        <!-- release date -->
                      <div class="mb-3">
                        <label for="exampleFormControlDate_${tvShow.id}" class="form-label">Release Date</label>
                          <input type="date" class="form-control" id="exampleFormControlDate_${tvShow.id}" name="release_date">
                      </div>
                        <!-- type -->
                      <div class="mb-3">
                        <label class="form-label">Type</label>
